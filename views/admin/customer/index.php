...
<?php startSection('content'); ?>
    ...
    <div class="card shadow-lg">
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-striped table-hover display responsive nowrap" id="tablaClientes" style="width: 100%;">
                    <thead>
                        <tr>
                            <th>Nro</th>
    ...
    <div class="modal fade" id="clienteModal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
                ...
                <form id="frmCliente" onsubmit="save(event);" autocomplete="off">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="lastname"><i class="fas fa-list"></i> Apellidos</label>
                                    <input id="lastname" class="form-control" type="text" name="nombre" placeholder="Apellidos del cliente" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
<?php startSection('scripts'); ?>
    <script>
        ...
        function editModal(id) {
            ...
            $.ajax({
                type: "get",
                url: `${api_admin_url}/customers/${id}`,
                headers: {
                    'Authorization': `Bearer ${token}`,
                },
                dataType: "json",
        ...
        function save(e) {
            ...
            if (document_number == '' || name == '' || lastname == '' || phone == '' || address == '') {
        ...
        $('#tablaClientes').on('click', '.update-status', function () {
            var id =  $(this).data('id');
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "put",
                        url: `${api_admin_url}/customers/status/${id}`,
                        headers: {
                            'Authorization': `Bearer ${token}`,
                        },
                        data: {
